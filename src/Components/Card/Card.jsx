...
import ModalDialogOverflow from '../ModalComment/ModalComment';
export default function InstagramPost({username, imgPublication, content, imgPerfil}) {
  ...
  const handlerShowComments = () => {
    setActiveModalComments((prev) => !prev);
  };


  return (
    <Card variant="outlined" sx={{ minWidth: 450, border: "solid 1px #9c9c9cbd", backgroundColor: "black",
     minHeight: 400, '--Card-radius': (theme) => theme.vars.radius.xs}}>
      <CardContent orientation="horizontal" sx={{ alignItems: 'center', gap: 1 }}>
        ...
        <IconButton variant="plain" color="neutral" size="sm" sx={{ ml: 'auto', '&:hover': {
      ...
      <CardContent orientation="horizontal" sx={{ alignItems: 'center', mx: -1 }}>
        <Box sx={{ width: 0, display: 'flex', gap: 0.5 }}>
          <IconButton variant="plain" color="neutral" size="sm" sx={{'&:hover': {
            backgroundColor: 'initial',
          },}}>
            <FavoriteBorder sx={{color: "white"}}/>
          </IconButton>
          <IconButton variant="plain" color="neutral" size="sm"
           onClick={handlerShowComments} sx={{'&:hover': {
            backgroundColor: 'initial',
          },}} >
            <ModeCommentOutlined sx={{color: "white"}}/>
          </IconButton>
          {activeModalComments && <ModalDialogOverflow/> }
          <IconButton variant="plain" color="neutral" size="sm"  sx={{'&:hover': {
            backgroundColor: 'initial',
          },}}>
